"""
2. Read the contents of the "show_arp.txt" file.
...
for line in data[1:]:
    ...
    if ip_addr == '10.220.88.30':
        ...
        fields_found += 1
    if fields_found == 2:
        print("Breaking out of the loop since 2 fields are found!")
        break

"""
Solution, https://github.com/ktbyers/pynet/blob/master/learning_python/lesson3/exercise2.py
