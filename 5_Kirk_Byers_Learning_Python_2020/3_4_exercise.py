...
for ip, mac in arp_table:
    ...
    for i in range(int(len(mac)/2)):
        mac_symbols.append(mac_temorary[:2])
        mac_temorary = mac_temorary[2:]
        pass
    #print(mac_symbols)
    mac_standartized.append(":".join(mac_symbols))

pprint(mac_standartized)
"""
...
Solution, https://github.com/ktbyers/pynet/blob/master/learning_python/lesson3/exercise4.py
